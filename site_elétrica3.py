...
with col_projeto:
    ...
    if not st.session_state.comodos:
        ...
        # Agrupamento 2: Tomadas de Uso Geral (TUGs)
        ...
        # Agrupamento 3: Tomadas de Uso Específico (TUEs)
        for c in st.session_state.comodos:
            if c['tue_w'] > 0:
                circuitos.append({"numero": c_num, "nome": f"TUE Exclusiva - {c['nome']}", "potencia": c['tue_w'], "tensao": c['tensao'], "tipo": "TUE", "dr": "OBRIGATORIO"})
                c_num += 1
        ...
        with divisao_aba:
            for circ in circuitos:
                ...
                <div style="border:1px solid #ddd; padding:15px; border-radius:8px; margin-bottom:12px; background-color:#1e222b;">
                    ...
                    <p style="margin:4px 0;">🛡️ <b>Dispositivo DR:</b> {circ['dr']} | <b>DPS:</b> Obrigatório Classe II</p>
                </div>
